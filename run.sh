...
git clone --depth=1 https://github.com/tant/odoo-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: pwdayne | Live chat port: $CHAT"